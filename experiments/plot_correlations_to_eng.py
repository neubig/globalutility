...
for INTEREST in 'ell,fra,spa,eng,cmn,swa,swe,fin,deu,hin'.split(','):
	...
	papers = [paper_num[l,INTEREST]+internal_paper_num[INTEREST,l] for l in languages]
	ec_dem1 = [(demand1[l,INTEREST]+demand1[l,INTEREST])/1000.0 for l in languages]
	ec_dem2 = [(demand2[l,INTEREST]+demand2[l,INTEREST])/1000.0 for l in languages]
	...
	fig.savefig(f"figs/to_lang/bleu_correlations_to_{INTEREST}_L1only.pdf", quality=100, format='pdf')
