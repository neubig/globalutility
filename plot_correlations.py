...
languages = list(
    set(constants.get_languages_to_Eng() + constants.get_languages_from_Eng())
)
...
papers = [
    paper_num[l, "eng"]
    + internal_paper_num[l, "eng"]
    + paper_num["eng", l]
    + internal_paper_num["eng", l]
    for l in languages
]
...
ax[0].scatter(
    populations, papers, marker="o", s=20, facecolors="none", edgecolors="blue"
)
