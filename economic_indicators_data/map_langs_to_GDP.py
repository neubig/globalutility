...
for l in lines[1:]:
	...
	elif iso in 'aao,abh,abv,acm,acq,acw,acx,acy,adf,aeb,aec,afb,ajp,apc,apd,arb,arq,ars,ary,arz,auz,avl,ayh,ayl,ayn,ayp,pga,shu,ssh'.split(','):
	...
	elif iso in 'hmc,hmm,cqd,hme,hmq,muq,hmj,mww,hnj,hrm,hmd,hml,huj,hmi,hmp,hea,sfm,hmy,hma,hms,hmg,hmh,hmw,hmz,mmr,blu'.split(','):
	...
	elif iso in 'btj,mfb,bjn,bve,kxd,bvu,pse,coa,liw,dup,hji,ind,jak,jax,vkk,meo,kvr,mqg,kvb,lce,lcf,zlm,xmm,min,mui,zmi,max,orn,ors,mfa,pel,msi,zsm,tmw,vkt,urk,mly'.split(','):
	...
	elif iso in 'qva,qxu,quy,qvc,qvl,qud,qxr,quk,qug,qxc,qxa,qwc,qwa,quz,qve,qub,qvh,qwh,qvw,qvi,qxw,quf,qvj,qvm,qvo,qul,qvn,qxn,qvz,qvp,qxh,qxp,qxl,qvs,qxt,qus,qws,quh,qxo,qup,quw,qur,qux,cqu'.split(','):
	...
	elif iso in 'zaq,zpo,zoo,zaf,zad,zpv,zpc,zca,zps,zpp,zte,zpg,ztu,zai,zpa,zpl,ztl,ztp,zpy,zam,zaw,zpm,zac,zao,zpe,zpj,ztq,zar,ztm,zpx,zab,zpf,zpt,ztn,zpn,zpi,zpr,zas,zaa,zpd,zsr,zat,ztt,zpz,zts,zpk,zph,zax,ztg,zpu,zae,zty,zav,zpb,ztx,zpw,zpq,ztc,xzp'.split(','):
		iso2country['zap'].add(country)
	elif iso in 'zch,zhd,zeh,zgb,zgn,zln,zlj,zlq,zgm,zhn,zqe,zyg,zyb,zyn,zyj,zzj,ccx,ccy'.split(','):
